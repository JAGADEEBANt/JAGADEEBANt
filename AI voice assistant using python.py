...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('tjagadeeban435@gmail.com', 'Jagadeeban@17')
...
if name == "main":
    ...
    #logic for executing tasks based on query
        ...
        if 'open youtube' in query:
            ...
            speak("I have been created by Jagadeeban.")
            ...
            speak("Thanks to Jagadeeban. further It's a secret")

        elif 'is love' in query:
            speak("It is 7th sense that destroy all other senses")

        elif "who are you" in query:
            speak("I am your virtual assistant created by Jagadeeban")

        elif 'reason for creating you' in query:
            speak("I was created as a Minor project by Mister Jagadeeban ")
